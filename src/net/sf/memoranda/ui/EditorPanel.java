...
EditorPanel extends JPanel 
{
	...
	public 
	EditorPanel (DailyItemsPanel parent) 
	{
		try 
		{
			parentPanel = parent;
	...
	void 
	insDateB_actionPerformed (ActionEvent e) 
	{
		editor.editor.replaceSelection (CurrentDate.get ().getFullDateString ());
	}

	void 
	insTimeB_actionPerformed (ActionEvent e) 
	{
	...
	void 
	exportB_actionPerformed (ActionEvent e) 
	{
	...
	void 
	importB_actionPerformed (ActionEvent e) 
	{
		// Fix until Sun's JVM supports more locales...
		UIManager.put ("FileChooser.lookInLabelText", Local
				.getString ("Look in:"));
	...
	void 
	newB_actionPerformed (ActionEvent e) 
	{
	...
	void 
	previewB_actionPerformed(ActionEvent e) 
	{
		File f;
		try 
		{
