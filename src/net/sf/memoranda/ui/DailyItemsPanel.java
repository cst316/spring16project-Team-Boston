...
public class 
DailyItemsPanel extends JPanel 
{
    ...
    public 
    DailyItemsPanel (WorkPanel _parentPanel) 
    {
        try
        {
...
//                // DEBUG
    ...
    void 
    currentDateChanged (CalendarDate newdate) 
    {
	...
	void 
	currentNoteChanged (Note note, boolean toSaveCurrentNote) 
	{
//		Util.debug("currentNoteChanged");
    ...
    void 
    currentProjectChanged (Project newprj, NoteList nl, TaskList tl, ResourcesList rl) 
    {
//		Util.debug("currentProjectChanged");
    ...
    void 
    toggleButton_actionPerformed (ActionEvent e) 
    {
        if (expanded) 
        {
            expanded = false;
    ...
    public void 
    updateIndicators (CalendarDate date, TaskList tl) 
    {
    ...
    void 
    alarmB_actionPerformed (ActionEvent e) 
    {
