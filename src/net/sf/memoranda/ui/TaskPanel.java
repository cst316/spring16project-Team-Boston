...
public class TaskPanel extends JPanel {
	...
	void newTaskB_actionPerformed(ActionEvent e) {
		...
		Task newTask = CurrentProject.getTaskList().createTask(sd, ed, dlg.todoField.getText(),
				dlg.priorityCB.getSelectedIndex(), effort, effortPredicted, dlg.descriptionField.getText(), null);
	...
	void addSubTask_actionPerformed(ActionEvent e) {
		...
		long effortPredicted = Util.getMillisFromHours(dlg.effortPredictedField.getText());
		Task newTask = CurrentProject.getTaskList().createTask(sd, ed, dlg.todoField.getText(),
				dlg.priorityCB.getSelectedIndex(), effort, effortPredicted, dlg.descriptionField.getText(), parentTaskId);
