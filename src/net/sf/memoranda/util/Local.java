...
public class Local 
{
    ...
    public static 
    String getWeekdayName (int wd) 
    {
        return getString (weekdaynames[wd - 1]);
    }

    public static 
    String getDateString (Date d, int f) 
    {
    ...
    public static 
    String getDateString (Calendar cal, int f) 
    {
    ...
    public static 
    String getDateString (CalendarDate date, int f) 
    {
        return getDateString (date.getDate (), f);
    }

    public static 
    String getDateString (int m, int d, int y, int f) 
    {
    ...
    public static 
    String getTimeString (Calendar cal) 
    {
    ...
    public static 
    String getTimeString (int hh, int mm) 
    {
